package com.leenanxi.android.open.common;
...
import com.leenanxi.android.open.common.ImagePicker.BottomSheetFragment;
import com.leenanxi.android.open.common.ImagePicker.ImagePickerSheetView;
...
public class SampleActivity extends AppCompatActivity {
    ...
    private List<Uri> mCameraImages;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sample_acitivy);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        mBottomSheetDialogFragment = new BottomSheetFragment();
    ...
    private boolean checkNeedsPermission() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN && ActivityCompat.checkSelfPermission(SampleActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED;
    }
    ...
    private void showWithSheetView(View view){
        if (mBottomSheet==null) {
            return;
        }
       if(((ViewGroup) mBottomSheet).getChildCount() == 0){
           ((ViewGroup) mBottomSheet).addView(view);
       }
    ...
    private File createImageFile() throws IOException {
        ...
        mCameraImages.add(Uri.fromFile(imageFile));
        return imageFile;
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == REQUEST_LOAD_IMAGE && data != null) {
                ...
                if(mCameraImages.size()>0){
                    selectedImage = mCameraImages.get(0);
                }
            }
